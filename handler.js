...
—◉ *Contacto para apelaciones:* wa.me/593991162279
╚═════════════════════╝
               `.trim();
              m.reply(messageText);
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;charly👑;;;\nFN:charly 👑\nORG:charly 👑\nTITLE:\nitem1.TEL;waid=593960070183:+593 9600 70 183\nitem1.X-ABLabel:charly 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:charly 👑\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: 'charly👑', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  const msg = {
    ...
    rowner: '*[ 🚨 𝔸𝕃𝔼ℝ𝕋𝔸 🚨 ] ᴄᴏᴍᴀɴᴅᴏ sᴏʟᴏ ᴘᴀʀᴀ ᴇʟ ᴘʀᴏᴘɪᴇᴛᴀʀɪᴏ ᴅᴇʟ ʙᴏᴛ*',
        owner: '*[ 🚨 𝔸𝕃𝔼ℝ𝕋𝔸 🚨 ] ᴄᴏᴍᴀɴᴅᴏ sᴏʟᴏ ᴘᴀʀᴀ ᴇʟ ᴘʀᴏᴘɪᴇᴛᴀʀɪᴏ ᴅᴇʟ ʙᴏᴛ*',
        mods: '*[ 🚨 𝔸𝕃𝔼ℝ𝕋𝔸 🚨 ] ᴄᴏᴍᴀɴᴅᴏ sᴏʟᴏ ᴘᴀʀᴀ  ᴍᴏᴅᴇʀᴀᴅᴏʀᴇs/ᴘʀᴏᴘɪᴇᴛᴀʀɪᴏ ᴅᴇʟ ʙᴏᴛ*',
        premium: '*[ 🚨 𝔸𝕃𝔼ℝ𝕋𝔸 🚨 ] ᴄᴏᴍᴀɴᴅᴏ sᴏʟᴏ ᴘᴀʀᴀ ᴜsᴜᴀʀɪᴏs ᴘʀᴇᴍɪᴜᴍ/ᴘʀᴏᴘɪᴇᴛᴀʀɪᴏ*',
        group: '*[ 🚨 𝔸𝕃𝔼ℝ𝕋𝔸 🚨 ] ᴄᴏᴍᴀɴᴅᴏ sᴏʟᴏ ᴘᴀʀᴀ ɢʀᴜᴘᴏs*',
        private: '*[ 🚨 𝔸𝕃𝔼ℝ𝕋𝔸 🚨 ] ᴄᴏᴍᴀɴᴅᴏ sᴏʟᴏ ᴘᴀʀᴀ ᴄʜᴀᴛs ᴘʀɪᴠᴀᴅᴏs*',
        admin: '*[ 🚨 𝔸𝕃𝔼ℝ𝕋𝔸 🚨 ] ᴄᴏᴍᴀɴᴅᴏ sᴏʟᴏ ᴘᴀʀᴀ ᴀᴅᴍɪɴs*',
        botAdmin: '*[ 🚨 𝔸𝕃𝔼ℝ𝕋𝔸 🚨 ] ᴘᴀʀᴀ ᴜsᴀʀ ᴇsᴛᴇ ᴄᴏᴍᴀɴᴅᴏ ᴇs ɴᴇᴄᴇsᴀʀɪᴏ ϙᴜᴇ ᴇʟ ɴᴜᴍᴇʀᴏ ᴅᴇʟ ʙᴏᴛ sᴇᴀ ᴀᴅᴍɪɴ*',
        unreg: '*[ 🚫 𝔸𝕃𝕋𝕆!! ℕ𝕆 𝔼𝕊𝕋𝔸 ℝ𝔼𝔾𝕀𝕊𝕋ℝ𝔸𝔻𝕆/𝔸 🚫 ]*\n\n*◉ ᴘᴀʀᴀ ᴜsᴀʀ ᴇsᴛᴇ ᴄᴏᴍᴀɴᴅᴏ  ᴅᴇʙᴇs ʀᴇɢɪsᴛʀᴀʀᴛᴇ, ᴜsᴀ ᴇʟ sɪɢᴜɪᴇɴᴛᴇ ᴄᴏᴍᴀɴᴅᴏ*\n*➣ #verificar nombre.edad*',
        restrict: '*[ 🚨 𝔸𝕃𝔼ℝ𝕋𝔸 🚨 ] ᴇsᴛᴇ ᴄᴏᴍᴀɴᴅᴏ ᴇsᴛᴀ ᴅᴇsᴀᴄᴛɪᴠᴀᴅᴏ ᴘᴏʀ ᴇʟ ᴘʀᴏᴘɪᴇᴛᴀʀɪᴏ ᴅᴇʟ ʙᴏᴛ*',
  }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '⚠ 𝐀𝐋𝐄𝐑𝐓𝐀', body: 'ɢᴏᴋᴜ ʙᴏᴛ', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/_777charly/'}}}}, aa);
