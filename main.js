...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '*@user* *ʙɪᴇɴᴠᴇɴɪᴅᴏ/ᴀ* \n*@subject*\n*ᴅᴇsᴄʀɪᴘᴄɪᴏ́ɴ ᴅᴇʟ ɢʀᴜᴘᴏ:*\n\n@desc\n\n*ᴅɪsғʀᴜᴛᴀ ᴇʟ ɢʀᴜᴘᴏ!!*';
conn.bye = '*@user*\n*ᴜɴ ʙᴏᴛ ᴍᴇɴᴏs 👋🏻* \n*ɴᴜɴᴄᴀ ɪᴍᴘᴏʀᴛᴏ*';
conn.spromote = '*@user ᴀsᴄᴇɴᴅɪᴏ́ ᴀ ᴀᴅᴍɪɴ!!*';
conn.sdemote = '*@user ɴᴏ ϙᴜɪsᴏ sᴇʀ ᴘʀᴏ!!*';
conn.sDesc = '*ᴜɴ ᴀᴅᴍɪɴ ᴍᴏᴅɪғɪᴄᴏ ʟᴀ ᴅᴇsᴄʀɪᴘᴄɪᴏ́ɴ*\n\n*ɴᴜᴇᴠᴏ ᴛᴇxᴛᴏ:* @desc';
conn.sSubject = '*ᴍᴏᴅɪғɪᴄᴏ ᴇʟ ɴᴏᴍʙʀᴇ ᴅᴇʟ ɢʀᴜᴘᴏ*\n*ᴄᴀᴍʙɪᴀᴅᴏ ᴄᴏɴ ᴇxɪᴛᴏ ᴀ:* @subject';
conn.sIcon = '*ᴄᴀᴍʙɪᴏ ʟᴀ ғᴏᴛᴏ ᴅᴇʟ ɢʀᴜᴘᴏ!!*';
conn.sRevoke = '*ʟɪɴᴋ ᴅᴇʟ ɢʀᴜᴘᴏ ʀᴇɴᴏᴠᴀᴅᴏ!!*\n*ɴᴜᴇᴠᴏ ʟɪɴᴋ:* @revoke';
...
setInterval(async () => {
  ...
  const bio = `📲_777ᴄʜᴀʀʟʏ┃ ᴀᴄᴛɪᴠᴏ: ${uptime}`;
